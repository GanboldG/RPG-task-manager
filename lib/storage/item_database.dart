...
class ItemDatabase {
  ...
  static final List<Item> allItems = [
    ...
    ItemFactory.createXpBoostItem(
      ...
      priceGold: 50,
      priceCrystal: 0,
      imageUrl: 'assets/images/items/common/minor_xp_potion.png',
      isPermanent: false,
      thresholdLevel: 0,
    ...
    ItemFactory.createGoldBoostItem(
      ...
      priceGold: 40,
      priceCrystal: 0,
      imageUrl: 'assets/images/items/common/gold_charm.png',
      isPermanent: false,
      thresholdLevel: 0,
      rarity: ItemRarity.common,
    ),
    ...
    ItemFactory.createCrystalChanceItem(
      ...
      priceGold: 180,
      priceCrystal: 10,
      imageUrl: 'assets/images/items/common/crystal_shard.png',
      isPermanent: false,
      thresholdLevel: 5,
      rarity: ItemRarity.uncommon,
    ),
